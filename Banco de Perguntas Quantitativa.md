...
**2 - Como funciona o processo de seleção em uma amostragem aleatória simples?**

Resposta: Todos os membros da população-alvo são listados e o pesquisador sorteia os participantes de forma que cada indivíduo tenha exatamente a mesma probabilidade de ser escolhido.
...
**4 - No contexto de testes estatísticos, o que se afirma através da Hipótese Nula (H0)?**
Resposta: A Hipótese Nula afirma que não existe uma diferença significativa, relação ou efeito entre as variáveis que estão sendo comparadas.

Contexto: Todo teste de hipótese começa assumindo que "nada mudou" ou que "o efeito é zero". O papel do pesquisador é analisar os dados para ver se há evidências suficientes para rejeitar essa ideia inicial em favor de uma mudança real.

**5 - Por que se deve evitar perguntar mais de uma coisa na mesma questão (pergunta composta) em um questionário?**
Resposta: Porque isso gera ambiguidade, já que o respondente pode concordar com uma parte da pergunta e discordar da outra, tornando a resposta impossível de analisar com precisão.

Contexto: Para que os dados quantitativos sejam confiáveis, cada pergunta deve ser direta e abordar apenas um tópico. Isso garante que, ao processar os dados, o pesquisador saiba exatamente ao que aquela resposta se refere.
